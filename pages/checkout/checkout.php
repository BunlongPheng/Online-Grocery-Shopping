...
<center>
<div class="header">
    <h1>E-Grocery Shopping</h1>
</div>

<div class="container">
    <div class="leftContainer">
    <h1 style="font-size: 16px">Reciept</h1>
...
<div class="rightContainer">
    <h2 style="font-family: Helvetica; font-size: 16px;">Delivery Form</h2>
    <br/>
    <label style="font-size: 10px; text-align: right">Attention: <span style="color:#FF0000">*</span> is required!</label>
    ...
    <table style="font-family: Arial, sans-serif;">
        ...
        <tr >
            <td colspan="2">
                <input type="submit" name="Confirm" value="Purchase" class="submit-button" style="margin-left: 40%; position: relative;">
        </tr>
        </td>
    </table>
</form>
